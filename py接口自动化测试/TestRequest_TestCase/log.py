...
class LogSignleton(object):
    ...
    def __new__(cls):#new在__init__之前
        config = configparser.ConfigParser()
        config.read(GetTestConfig("logconfig.conf"),encoding='utf-8')
        LOGGING='LOGGING'
        ...
        if not hasattr(cls, 'instance'):
            ...
            cls.instance.console_log_on = config[LOGGING]['console_log_on']#开关，1开0关
